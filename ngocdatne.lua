...
print("i love ngoc dat")
print("i love hoacodon")
print("load succes")
local Notification = require(game:GetService("ReplicatedStorage").Notification)
Notification.new("<Color=Yellow> Loading <Ngoc Dat Hub Ver2> <Color=/>"):Display()
Notification.new("<Color=Red> Made by Ngoc Dat <Color=/>"):Display()
Notification.new("<Color=Blue> Discord:https://discord.com/invite/c2eJX9R8EK <Color=/>"):Display()
-------------------// I Write... \\----------------------------------------
...
local Window = OrionLib:MakeWindow({Name = "Ngoc Dat Hub Ver2", HidePremium = false, SaveConfig = true, ConfigFolder = "Ngoc Dat Hub Ver2"})

function Notify(h,i)
    OrionLib:MakeNotification({
        Name = "Ngoc Dat Hub Ver2",
        Content = h,
        Time = i
    })
end

Notify("Welcome To Ngoc Dat Hub Ver2 Release",5)
...
I:AddLabel("Owner : Ngoc Dat ")

I:AddLabel("hoacodon and soi co doc")
I:AddLabel("Version : Main")

I:AddLabel("8/6 on top")
