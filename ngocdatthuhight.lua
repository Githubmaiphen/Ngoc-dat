game.StarterGui:SetCore("SendNotification", {
      Icon = "rbxassetid://16285427595";
      Title = "Ngoc Dat Hub Ver2", 
      Text = "No Key For Now!!",
       Button1 = "Ok cool",
  })
...
TITLE.Text = "Ngoc Dat Hub | LOADER"
...
--------------------------------------------------------------------
local Library = Update:Window("Ngoc Dat Hub","11354741327")
--------------------------------------------------------------------
...
--------------------------------------------------------------------
Update:Notification("Hello, " ..game.Players.LocalPlayer.DisplayName.. " Welcome To Ngoc Dat Hub Mobile! Enjoy Using it! ")
...
Main:Button("Mink Fake Transform",function()
    require(game:GetService("ReplicatedStorage").Notification).new("Mink V4! / By : Ngoc Dat Hub"):Display();
    wait()
    setthreadcontext(5)
    ...
    require(game:GetService("ReplicatedStorage").Notification).new("Fishman V4! / By : Ngoc Dat Hub"):Display();
    wait()
    setthreadcontext(5)
    ...
    require(game:GetService("ReplicatedStorage").Notification).new("Skypeian V4! / By : Ngoc Dat Hub"):Display();
    wait()
    setthreadcontext(5)
    ...
    require(game:GetService("ReplicatedStorage").Notification).new("Ghoul V4! / By : Ngoc Dat Hub"):Display();
    wait()
    setthreadcontext(5)
    ...
    require(game:GetService("ReplicatedStorage").Notification).new("Cyborg V4! / By : Ngoc Dat Hub"):Display();
    wait()
    setthreadcontext(5)
    ...
    require(game:GetService("ReplicatedStorage").Notification).new("Human V4! / By : Ngoc Dat Hub"):Display();
    wait()
    setthreadcontext(5)
