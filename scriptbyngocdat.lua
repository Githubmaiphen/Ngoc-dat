...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Ngoc Dat Hub chào ae<Color=/>"):Display()
    wait(.5)
    ...
    wait(.29)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Đăng ký kênh KoMonZi <Color=/>"):Display()
    wait(.36)
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "Ngoc Dat Hub", HidePremium = false, IntroText = "Ngoc Dat Hub⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("Ngoc Dat Hub SCRIPT")
W:AddLabel("DiscordNgoc Dat Hub")
local Section = W:AddSection({
    Name = "Status"
})
